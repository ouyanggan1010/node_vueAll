<template>
  <div class="page-hero" v-if="model">
    <div class="topbar bg-black py-2 px-3 d-flex ai-center text-white">
      ...
      <router-link to="/home" tag="div" class>更多英雄&gt;</router-link>
    </div>
    <div class="top" :style="{'background-image':`url(${model.banner})`}">
      <div class="info text-white p-3 d-flex flex-column jc-end h-100">
        ...
        <div class="d-flex jc-between">
          ...
          <router-link to="/home" tag="div" class="text-grey fs-sm">皮肤：2 &gt;</router-link>
        </div>
      </div>
    </div>
    <!-- end of top -->
        ...
        <swiper-slide>
          <div>
            <div class="p-3 bg-white border-bottom">
              <div class="d-flex">
                <router-link tag="div" to="/home" class="btn btn-lg flex-1">
                  <i class="iconfont icon-menu"></i>
                  英雄介绍视频
                </router-link>
                <router-link tag="div" to="/home" class="btn btn-lg flex-1 ml-2">
                  <i class="iconfont icon-menu"></i>
                  一图识英雄
                </router-link>
              </div>
              ...
              <div class="skills mt-4">
                ...
                <div v-if="currentSkill">
                  ...
                  <p class="fs-lg">{{currentSkill.description}}</p>
